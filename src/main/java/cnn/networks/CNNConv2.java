...
public class CNNConv2 {
    ...
    public CNNConv2(int inX, int inY) {
        this.inX = inX;
        this.inY = inY;

        exportName = "exportBirdsLargeDecay";
        ...
        try {
            ...
            r3 = new ReLU1D();
            d1 = new DenseLayer(p2.getFlattenedSize(), 64);
            d2 = new DenseLayer(d1.getOutputSize(), 18);
            s1 = new Softmax();
        } catch (Exception e) {
